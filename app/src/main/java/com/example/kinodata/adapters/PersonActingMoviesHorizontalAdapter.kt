...
class PersonActingMoviesHorizontalAdapter
    : RecyclerView.Adapter<PersonActingMoviesHorizontalAdapter.MyViewHolder>() {
    ...
    class PersonMoviesDiffCallback(
        var oldList: List<PersonActingMovies>,
        var newList: List<PersonActingMovies>
    ) : DiffUtil.Callback() {
