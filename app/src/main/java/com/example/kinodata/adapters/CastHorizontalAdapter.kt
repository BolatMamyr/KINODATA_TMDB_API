...
class CastHorizontalAdapter : RecyclerView.Adapter<CastHorizontalAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            txt_name = itemView.findViewById(R.id.txt_actorName)
            txt_characterName = itemView.findViewById(R.id.txt_characterName)
        }
    }
